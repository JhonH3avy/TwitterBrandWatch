...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\JhonContreras\source\repos\MyMLApp\MyMLApp\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LinearSvm(new LinearSvmTrainer.Options() { Lambda = 0.07507725f, PerformProjection = true, NoBias = false, NumberOfIterations = 19, InitialWeightsDiameter = 0.5194541f, Shuffle = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
